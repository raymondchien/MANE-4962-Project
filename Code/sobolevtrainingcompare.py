# -*- coding: utf-8 -*-
"""sobolevtrainin.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1PFWOH0e1WLYTtfa87P6pZ-uq7HvPwF7z
"""

#ctrl+b to split cell at cursor location
import torch
...
#Defining the structure of the NN model,
class Net(nn.Module):
...
def train(lam1, loader, EPOCH, BATCH_SIZE):
    ...
    for epoch in range(EPOCH):
        scheduler.step()
        epoch_mse0 = 0.0 #i think this is for the output and derivative
        epoch_mse1 = 0.0
        ...
        for step, (batch_x, batch_y) in enumerate(loader):  # for each training step
            ...
            loss = mse0 + lam1 * mse1 #loss is a function of all the inputs lol
